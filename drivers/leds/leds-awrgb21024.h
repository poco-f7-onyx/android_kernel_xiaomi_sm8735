...
#define RGB_MAX(a, b, c) \
	((a) > (b) ? ((a) > (c) ? (a) : (c)) : ((b) > (c) ? (b) : (c)))
#define RGB_MIN(a, b, c) \
	((a) < (b) ? ((a) < (c) ? (a) : (c)) : ((b) < (c) ? (b) : (c)))
#define RGB_MID(a, b, c) \
	(((a) + (b) + (c)) - RGB_MAX(a, b, c) - RGB_MIN(a, b, c))
...
static const unsigned int breath_timerms_map_reg[] = {
	0,    0x00, 130,  0x01, 260,  0x02, 380,  0x03, 510,  0x04, 770,
	0x05, 1040, 0x06, 1600, 0x07, 2100, 0x08, 2600, 0x09, 3100, 0x0A,
	4200, 0x0B, 5200, 0x0C, 6200, 0x0D, 7300, 0x0E, 8300, 0x0F,
};
