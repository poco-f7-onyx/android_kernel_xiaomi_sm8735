...
{
	struct chg_ulog_glink_dev *cd = container_of(
		work, struct chg_ulog_glink_dev, adsp_dump_log_work);
	struct get_ulog_req_msg req_msg = { { 0 } };
...
static void handle_adsp_log(struct chg_ulog_glink_dev *cd, void *data,
			    size_t len)
{
...
DEFINE_DEBUGFS_ATTRIBUTE(dump_adsp_log_fops, dump_adsp_log_get,
			 dump_adsp_log_set, "%llu\n");
