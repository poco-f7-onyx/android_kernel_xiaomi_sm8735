...
#define FP_RESET_DEFAULT_TIME 10
...
#define FP_IOC_REGULATOR_ENABLE_PWM _IO(FP_IOC_MAGIC, 42)
#define FP_IOC_REGULATOR_DISABLE_PWM _IO(FP_IOC_MAGIC, 43)
